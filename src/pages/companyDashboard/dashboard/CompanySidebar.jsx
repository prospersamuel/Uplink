    ...
    <AnimatePresence>
      {sidebarOpen && (
        ...
        ref={sidebarRef}
          ...
          className={`w-72 md:w-[25%] bg-white/80 dark:bg-slate-900/80 backdrop-blur-lg border-r border-slate-200/50 dark:border-slate-800/50 p-6 flex flex-col gap-8 fixed h-screen overflow-y-auto md:relative z-40`}
        >
          <motion.div
