    ...
    <div className="mt-6 flex justify-between">
      ...
      {currentStep < steps.length - 1 ? (
        ...
        <button
          ...
          className="px-4 py-2 disabled:opacity-45 disabled:cursor-not-allowed text-sm rounded-md bg-green-500 text-white hover:bg-green-600 transition-colors flex items-center gap-2"
        >
          <FiPlus size={16} />
